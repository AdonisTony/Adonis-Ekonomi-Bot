...
const { elektronikMarket } = require("../Configs/ecoConfig");
...
module.exports = {
  ...
  aliases: [],
  description:
    "Elektronik market üzerinden elektornik eşya satın alabilirsiniz.",
  guildOnly: true,
  marketType: "Elektronik Market",
  category: "Market",
  satıcı: "Elektronikçi",
  async execute(message, args, bot) {
    ...
    try {
      ...
      const list = [...elektronikMarket.values()];
      ...
      const generateEmbed = async (start) => {
        ...
        return new MessageEmbed().setColor("RANDOM").addField(
          ...
          }\` ${message.guild.emojis.cache.get(bakiyen)}`,
          `\`\`\`css
${table.table(market, {

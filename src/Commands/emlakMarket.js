...
const { emlakMarket } = require("../Configs/ecoConfig");
...
module.exports = {
  name: "emlak-market",
  aliases: [],
  description: "Emlak market üzerinden ev satın alabilirsiniz.",
  guildOnly: true,
  marketType: "Emlak Market",
  category: "Market",
  satıcı: "Emlakçı",

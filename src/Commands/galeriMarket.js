...
const { galeriMarket } = require("../Configs/ecoConfig");
...
module.exports = {
  name: "galeri-market",
  aliases: [],
  description: "Galeri market üzerinden araç satın alabilirsiniz.",
  guildOnly: true,
  marketType: "Galeri Market",
  category: "Market",
  satıcı: "Galerici",
  async execute(message, args, bot) {
    ...
    try {
      ...
      const list = [...galeriMarket.values()];
